<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<%
	//로그인되지 않은 회원에게 로그인 필요하다고 창 띄워주기
	if(session.getAttribute("midx") == null) {
	  /*login후경로1*/session.setAttribute("saveUrl", request.getRequestURI());
	//로그인되지 않은 회원에게 로그인 필요하다고 창 띄워주기
...
function check() {
  ...
  //파일업로드 2 : 'fm.enctype="multi/form-data";' 추가
	...
	<div class="formBox">
		<form name="frm">
			<table class="smallTable">
				...
				<tr>
				     <!--회원글쓰기작성자 1 : 로그인 후 글쓰기 작성자를 로그인한 회원이름으로 -->
					<td><b>작성자</b></td>
